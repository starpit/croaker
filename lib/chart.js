...
exports.init = (graphics, options={}) => {
    ...
    var chartData = {
        ...
        datasets: [
            ...
            { type, fill: '-1', label: '25-75% Band', data: [], borderColor: bar.latency75.border, backgroundColor: bar.latency75.bg, borderWidth, pointRadius, yAxisID, lineTension },
            ...
            { type, fill: '-1', label: 'Min-Max Band', data: [], borderColor: bar.latencyMinMax.border, backgroundColor: bar.latencyMinMax.bg, borderWidth, pointRadius, yAxisID, lineTension },
